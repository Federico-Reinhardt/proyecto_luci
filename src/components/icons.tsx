...
export function IconBuilding({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <rect x="11" y="10.5" width="2" height="2" />
      <rect x="15" y="10.5" width="2" height="2" />
      <rect x="7" y="14.5" width="2" height="2" />
      <rect x="15" y="14.5" width="2" height="2" />
      <rect x="10" y="17.5" width="4" height="3.5" />
    </svg>
  );
}
...
export function IconMeeting({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M6.5 13l-1.5 3v-3" />
      <rect x="8" y="10" width="13" height="9" rx="2" />
      <path d="M17.5 19l1.5 3v-3" />
    </svg>
  );
}
...
export function IconUsers({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M2.5 20.5v-1.2a4.8 4.8 0 0 1 4.8-4.8h3.4a4.8 4.8 0 0 1 4.8 4.8v1.2" />
      <circle cx="17.5" cy="8.3" r="2.4" />
      <path d="M21.5 20.5v-1a4 4 0 0 0-3-3.87" />
    </svg>
  );
}
